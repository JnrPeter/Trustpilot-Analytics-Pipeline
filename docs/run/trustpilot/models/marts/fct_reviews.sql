...
create or replace transient table TRUSTPILOT_REVIEWS.DEV.fct_reviews
...
with reviews as (
    select * from TRUSTPILOT_REVIEWS.DEV.stg_reviews
),

countries as (
    select * from TRUSTPILOT_REVIEWS.DEV.country_codes
),
